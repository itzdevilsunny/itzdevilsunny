...
🚀 Passionate **Full-Stack Developer**, **AI Enthusiast**, and **Hackathon Innovator** currently pursuing **B.Sc. (Hons.) Computer Science** at the University of Delhi.
...
🌱 Currently exploring **System Design**, **Microservices Architecture**, **Cloud Computing (AWS & GCP)**, **LLMs**, **RAG**, **MCP Servers**, and **Production-Grade AI Applications**.
...
![Google Gemini](https://img.shields.io/badge/Google_Gemini-8E75FF?style=for-the-badge&logo=google&logoColor=white)
